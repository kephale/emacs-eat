...
Eat isn't available on any ELPA right now.  So, you have to follow one
...
native-compiled Term even without byte-compilation.  Also, it
flickers, just try to run =emacs -nw= in it.
